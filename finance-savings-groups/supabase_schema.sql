...
-- Run these separately ONLY if supabase_realtime publication exists.
-- In Supabase dashboard: Database → Replication → supabase_realtime → add tables
-- These lines are optional and safe to skip if they cause errors:
